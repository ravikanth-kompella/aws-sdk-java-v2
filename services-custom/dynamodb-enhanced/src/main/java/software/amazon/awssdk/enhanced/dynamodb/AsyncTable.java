...
public interface AsyncTable {
     ...
     *
     * <p>
     * This call should never fail with a {@link RuntimeException}.
     */
    default String name() {
     ...
     *
     * <p>
     * This call should never throw a {@link RuntimeException}. All exceptions will be returned via the produced
